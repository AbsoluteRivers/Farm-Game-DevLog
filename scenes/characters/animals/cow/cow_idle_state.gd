...
func _on_physics_process(_delta : float) -> void:
	...
	if cow_npc.npc_direction == Vector2.RIGHT:
		animated_sprite_2d.play("idle_a")


func _on_next_transitions() -> void:
	#print("Cow checking transitions | timeout = ", idle_state_timeout)
